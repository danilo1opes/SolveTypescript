...
var fetchData_js_1 = require("./fetchData.js");
var normalizeTransaction_js_1 = require("./normalizeTransaction.js");
var Statistic_js_1 = require("./Statistic.js");
function handleData() {
    return __awaiter(this, void 0, void 0, function () {
        var data, transacoes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, fetchData_js_1.default)('https://api.origamid.dev/json/transacoes.json?')];
                case 1:
                    data = _a.sent();
                    if (!data)
                        return [2 /*return*/];
                    transacoes = data.map(normalizeTransaction_js_1.default);
